...
export const POA_TEXTS = {
    '1.0.0': [
        ...
        `I acknowledge and agree that the Site solely provides access and information for data on the blockchain; displayed information may be approximate or contain inaccuracies. I accept that Site operators have no custody over my funds, ability or duty to transact on my behalf or power to reverse my transactions. The Site does not provide any warranty with respect to any of its provided operations.`,
    ],
}
