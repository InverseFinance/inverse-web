...
export const DOLA_BRIDGED_CHAINS = [NetworkIds.ftm, NetworkIds.optimism, NetworkIds.bsc, NetworkIds.arbitrum, NetworkIds.polygon, NetworkIds.avalanche];
