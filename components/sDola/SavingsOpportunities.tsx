            ...
            <VStack spacing="8" alignItems="flex-start" w='full'>
                ...
                <VStack alignItems="flex-start">
                    <Text fontWeight="bold" textDecoration="underline">
                        Stables that you can put to work:
                    </Text>
                    ...
                    </HStack>
                    {
                        balances
                            ...
                            .map(b => {
                                return <HStack key={b.token.address} w='200px' justify="space-between">
                                    <UnderlyingItemBlock {...b.token} label={b.token.symbol} />
                                    <Text>{shortenNumber(b.balance, 2)}</Text>
                                </HStack>
                            })
                    }
                </VStack>
