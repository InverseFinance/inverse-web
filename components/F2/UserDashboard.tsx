...
export const NumberAndPieCard = ({ isLoading, title, footer = undefined, noDataFallback = undefined, fill, activeFill, data, value, label, width = 350, height = 250, dataKey = 'value', nameKey = 'name', precision = 2, isUsd = false, pieProps, ...props }) => {
