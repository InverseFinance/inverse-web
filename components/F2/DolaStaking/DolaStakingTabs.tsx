...
export const DolaStakingTabs = ({
    ...
    >
        <TabList justifyContent={{ base: 'flex-start', sm: 'center' }}>
            <Tab color={defaultIndex === 0 ? 'mainTextColor' : 'mainTextColorLight'} as={Link} href="https://earn.inverse.finance" _focus={{ outline: 'none' }}>sDOLA</Tab>
...
export const JDolaStakingTabs = ({
    ...
    >
        <TabList justifyContent={{ base: 'flex-start', sm: 'center' }}>
            <Tab color={defaultIndex === 0 ? 'mainTextColor' : 'mainTextColorLight'} as={Link} href="https://earn.inverse.finance" _focus={{ outline: 'none' }}>jrDOLA</Tab>
