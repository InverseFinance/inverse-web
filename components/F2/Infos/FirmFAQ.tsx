    ...
    const items = [
        ...
        },
        {
            ...
            body: <FaqStack alignItems="flex-start">
                <FaqText>
                    <b>DBR are borrowing credits</b> you can buy and sell at a market price, <b>they are consumed at a constant rate according to your loan size</b> if any.
                </FaqText>
                <FaqText>
                    DBR stands for <b>DOLA Borrowing Rights</b>, in technical terms it's an ERC20 token, used as tokenized interest.
                </FaqText>
                <FaqText>
