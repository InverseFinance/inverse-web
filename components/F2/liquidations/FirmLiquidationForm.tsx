    ...
    return <VStack w='full' p="4">
        ...
        }
        {
            ...
            <VStack pt="4" w='full' alignItems="flex-start">
                ...
                />
                <InfoMessage description="Note: repay on-behalf is not a liquidation, but a simple repay without anything in return, for example to repay debt of another account you own." />
            </VStack>
        }
    </VStack>
}