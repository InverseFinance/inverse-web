...
export const SafetyMiniCaroussel = () => {
    ...
    return <VStack w={`${badgeW}px`} h="50px" overflow="hidden" position="relative" pt={{ base: '4', sm: '0' }} display={{ base: 'none', sm: 'inline-flex' }} spacing="0" alignItems="flex-end">
        ...
        <Link transition="500ms all" position="absolute" right={`${badgeX + badgeW}px`} bgImage="/assets/partners/sherlock.png?" bgRepeat="no-repeat" bgColor="#f5f7fe" width={`${badgeW}px`} h="50px" href="https://audits.sherlock.xyz/bug-bounties/233/" border="1px solid #e9effc" borderRadius="5px" bgSize='cover' bgPosition="center" isExternal target="_blank">
            &nbsp;
        </Link>
    </VStack>
}
...
export const SafetyBadges = () => {
    return <HStack spacing="2" h="50px" position="relative" pt={{ base: '4', sm: '0' }} display={{ base: 'none', sm: 'inline-flex' }} alignItems="flex-end">
        <Link _hover={{ filter: 'brightness(1.1)' }} bgImage="/assets/partners/sherlock.png?" bgRepeat="no-repeat" bgColor="#f5f7fe" width={`${badgeW}px`} h="50px" href="https://audits.sherlock.xyz/bug-bounties/233/" border="1px solid #e9effc" borderRadius="5px" bgSize='cover' bgPosition="center" isExternal target="_blank">
            &nbsp;
        </Link>
