...
export const Layout = ({ children, isLanding, hideFooter = false, isLandingV2 = false, bgColor = 'mainBackgroundColor', bg = 'mainBackground', ...props }: {
  ...
  <Flex
    ...
    {
      isLandingV2 || hideFooter ? null : isLanding ?
        <Stack
