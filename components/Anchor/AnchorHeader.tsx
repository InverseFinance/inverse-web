import { Text, Stack, Image, useBreakpointValue } from '@chakra-ui/react';
  ...
  if(!isLoading) {
    ...
    return (
      <Stack p={8} m={4} spacing={6} direction="row" w="full" borderRadius={16} borderWidth="1px" borderColor="#211e36">
        {showImage && <Image boxSize="200px" src="/assets/products/anchor.png" alt="DOLA" />}
        <Stack spacing={6} w="full">
          ...
          <Stack w={{ base: 60, lg: 80 }} spacing={2} direction="row" pt={4}>
