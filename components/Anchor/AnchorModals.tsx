        ...
        <Box w="100%">
          {
            preventDisabling ?
              ...
              />
              :
              <SubmitButton needPoaFirst={true} disabled={asset.collateralGuardianPaused && !asset.isCollateral} onClick={handleConfirm} refreshOnSuccess={true} onSuccess={() => onClose()}>
