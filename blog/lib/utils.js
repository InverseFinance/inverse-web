...
export const getLandingProps = async ({ preview = false, ...context }) => {
    ...
    return {
        props: { preview: isPreview, posts, totalDebt, currentCirculatingSupply: parseFloat(currentCirculatingSupply), apy, projectedApy, dolaPrice, dbrPriceUsd, firmTotalTvl, invPrice: invFirmPrice, dolaVolume },
    }
}
