    ...
    <Layout>
      ...
      >
        ...
        {/* <Text mt="50px" textAlign="center" fontSize="14px" color="secondaryTextColor">
            Please read our <Link href="https://docs.inverse.finance/inverse-finance/inverse-finance/products/firm" isExternal target="_blank" as="a" textDecoration="underline" color="secondaryTextColor">
              Docs
