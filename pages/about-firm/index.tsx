    ...
    <Layout>
      ...
      >
        ...
        {/* <Text mt="50px" textAlign="center" fontSize="14px" color="secondaryTextColor">
            Please read our <Link href="https://inverse-dao.gitbook.io/inverse-finance/inverse-finance/firm" isExternal target="_blank" as="a" textDecoration="underline" color="secondaryTextColor">
              Docs
