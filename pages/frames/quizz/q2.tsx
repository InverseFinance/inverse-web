  ...
  return (
    <>
      <Head>        
        ...
        <meta property="fc:frame:image" content="https://inverse.finance/assets/sDOLA.x512.png" />
        <meta property="og:image" content="https://inverse.finance/assets/sDOLA.x512.png" />
