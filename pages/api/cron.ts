...
export default async function handler(req, res) {
    ...
    try {
        ...
        const getProposals = async (proposalCount: BigNumber, govContract :Contract, proposalsCreated: any[], votesCast: any[], quorumVotes: BigNumber) => {
        ...
        const proposals = await getProposals(proposalCount, governance, proposalsCreated, votesCast, quorumVotes);
        const proposalsAlpha = await getProposals(proposalCountAlpha, governanceAlpha ,proposalsCreatedAlpha, votesCastAlpha, quorumVotesAlpha);
