...
export const get0xSellQuote = async (buyAd: string, sellAd: string, sellAmount: string, slippagePerc = '1') => {
...
export const get0xBuyQuote = async (buyAd: string, sellAd: string, buyAmount: string, slippagePerc = '1') => {
    const slippage = parseFloat(slippagePerc) / 100;
