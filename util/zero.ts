...
export const get0xSellQuote = async (buyAd: string, sellAd: string, sellAmount: string, slippage = 0.04) => {
...
export const get0xBuyQuote = async (buyAd: string, sellAd: string, buyAmount: string, slippage = 0.04) => {
