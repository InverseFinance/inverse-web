...
const chainTokenAddresses = {
  "1": {
    ...
    YVDOLAFRAXBP: '0xe5F625e8f4D2A038AE9583Da254945285E5a77a4',
    ...
    PTsUSDe29MAY25: '0xb7de5dFCb74d25c2f21841fbd6230355C50d9308',
    PTsUSDe31JUL25: '0x3b3fB9C57858EF816833dC91565EFcd85D96f634',
    PTsUSDe25SEP25: '0x9F56094C450763769BA0EA9Fe2876070c0fD5F77',
    PTUSDe25SEP25: '0xBC6736d346a5eBC0dEbc997397912CD9b8FAe10a',
    PTsUSDe27NOV25: '0xe6A934089BBEe34F832060CE98848359883749B3',
    PTUSDe27NOV25: '0x62C6E813b9589C3631Ba0Cdb013acdB8544038B7',
...
const chainTokens = {
  "1": {
    ...
    [chainTokenAddresses["1"].USR]: {
      address: chainTokenAddresses["1"].USR,
      name: 'USR',
      symbol: 'USR',
    ...
    [chainTokenAddresses["1"].deUSD]: {
      address: chainTokenAddresses["1"].deUSD,
      name: 'deUSD',
      symbol: 'deUSD',
      coingeckoId: 'elixir-deusd',
      image: TOKEN_IMAGES.deUSD,
      decimals: 18,
      isStable: true,
    },
    [chainTokenAddresses["1"].sdeUSD]: {
      address: chainTokenAddresses["1"].sdeUSD,
      name: 'sdeUSD',
      symbol: 'sdeUSD',
      coingeckoId: 'elixir-staked-deusd',
      image: TOKEN_IMAGES.sdeUSD,
      decimals: 18,
      isStable: true,
    },
    [chainTokenAddresses["1"].reUSD]: {
      address: chainTokenAddresses["1"].reUSD,
      name: 'reUSD',
      symbol: 'reUSD',
      coingeckoId: 'resupply-usd',
      image: TOKEN_IMAGES.reUSD,
      decimals: 18,
      isStable: true,
    },
    ...
    [chainTokenAddresses["1"].YVDOLASCRVUSDCLP]: {
      ...
      name: 'yv-DOLA-scrvUSD',
      symbol: 'yv-DOLA-scrvUSD',
      protocolImage: PROTOCOL_IMAGES.YFI,
    ...
    [chainTokenAddresses["1"].YVDOLAFRAXBP]: {
      address: chainTokenAddresses["1"].YVDOLAFRAXBP,
      name: 'yv-DOLA-FraxBP',
      symbol: 'yv-DOLA-FraxBP lp',
      protocolImage: PROTOCOL_IMAGES.YFI,
      ...
      link: `https://yearn.fi/vaults/1/${chainTokenAddresses["1"].YVDOLAFRAXBP.toLowerCase()}`,
    },
    ...
    [chainTokenAddresses["1"].PTsUSDe29MAY25]: {
      address: chainTokenAddresses["1"].PTsUSDe29MAY25,
    ...
    [chainTokenAddresses["1"].PTUSDe25SEP25]: {
      address: chainTokenAddresses["1"].PTUSDe25SEP25,
      name: 'PT-USDe-25SEP25',
      symbol: 'PT-USDe-25SEP25',
      image: TOKEN_IMAGES.USDe,
      decimals: 18,
      isStable: true,
    },
    [chainTokenAddresses["1"].PTsUSDe27NOV25]: {
      address: chainTokenAddresses["1"].PTsUSDe27NOV25,
      name: 'PT-sUSDe-27NOV25',
      symbol: 'PT-sUSDe-27NOV25',
      image: TOKEN_IMAGES.sUSDe,
      decimals: 18,
      isStable: true,
    },
    [chainTokenAddresses["1"].PTUSDe27NOV25]: {
      address: chainTokenAddresses["1"].PTUSDe27NOV25,
      name: 'PT-USDe-27NOV25',
      symbol: 'PT-USDe-27NOV25',
      image: TOKEN_IMAGES.USDe,
      decimals: 18,
      isStable: true,
    },
    ...
    [chainTokenAddresses["1"].sfrxUSD]: {
      address: chainTokenAddresses["1"].sfrxUSD,
      name: 'sfrxUSD',
      symbol: 'sfrxUSD',
      coingeckoId: 'staked-frax-usd',      
      image: TOKEN_IMAGES.sfrxUSD,
      decimals: 18,
      isStable: true,
    },
  ...
  "8453": {
    ...
    [chainTokenAddresses["8453"].DOLAZUNUSDLP]: {
      address: chainTokenAddresses["8453"].DOLAZUNUSDLP,
      name: 'DOLA-zunUSD',
      symbol: 'DOLA-zunUSD aerolp',
      image: TOKEN_IMAGES.DOLA,
      decimals: 18,
      isLP: true,      
      isVeloLP: true,
