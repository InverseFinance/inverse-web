...
const mainConfig = {
    ...
    feds: [
        ...
        { chainId: NetworkIds.mainnet, type: 'Cross', protocol: 'Fuse', address: '0xe3277f1102C1ca248aD859407Ca0cBF128DB0664', name: 'Fuse6 Fed', projectImage: '/assets/projects/Fuse.png' },
        { chainId: NetworkIds.mainnet, type: 'Cross', protocol: 'Fuse', address: '0x7765996dAe0Cf3eCb0E74c016fcdFf3F055A5Ad8', name: 'Badger Fed', projectImage: '/assets/projects/Fuse.png' },
        { chainId: NetworkIds.mainnet, type: 'Cross', protocol: 'Fuse', address: '0x5Fa92501106d7E4e8b4eF3c4d08112b6f306194C', name: '0xb1 Fed', projectImage: '/assets/projects/Fuse.png' },
        { chainId: NetworkIds.mainnet, type: 'Cross', protocol: 'Fuse', hasEnded: true, address: '0xCBF33D02f4990BaBcba1974F1A5A8Aea21080E36', name: 'Fuse24 Fed', projectImage: '/assets/projects/Fuse.png' },
